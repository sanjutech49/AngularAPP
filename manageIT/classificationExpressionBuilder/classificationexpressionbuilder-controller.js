manageitModule.controller("classificationExpressionBuilderController", ['$scope', '$rootScope', 'newSharedScope', 'sharedScope', 'classificationService', 'classificationSubObjectService', 'classificationexpressionbuilderService', '$routeParams',
    function ($scope, $rootScope, newSharedScope, sharedScope, classificationService, classificationSubObjectService, classificationexpressionbuilderService, $routeParams) {
        newSharedScope.store('classificationExpressionBuilderController', $scope);
