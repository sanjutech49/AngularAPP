(function () {
    "use strict";
    function ChangePasswordController($scope, $location, userProfileServices, store, SSOService, configUrlModel) {
        var userScope = this;
        var Reply = "";
        userScope.errors = {
            profileChange: [],
    ...
    changePasswordModule.controller('ChangePasswordController', ['$scope', '$location', 'userProfileServices', 'store', 'SSOService', 'configUrlModel', ChangePasswordController]);
}());
